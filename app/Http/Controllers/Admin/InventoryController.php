...
class InventoryController extends Controller
{
    ...
    public function index()
    {
        ...
        $inventories = Inventory::with(['category', 'brand', 'media'])->get();

        $categories = Category::get();

        $brands = Brand::get();

        return view('admin.inventories.index', compact('inventories', 'categories', 'brands'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.inventories.create', compact('categories', 'brands'));
    }
    ...
    public function edit(Inventory $inventory)
    {
        ...
        $inventory->load('category', 'brand');

        return view('admin.inventories.edit', compact('categories', 'brands', 'inventory'));
    }
