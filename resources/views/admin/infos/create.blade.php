    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.infos.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('about_en') ? 'is-invalid' : '' }}" name="about_en" id="about_en">{{ old('about_en') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('about_ar') ? 'is-invalid' : '' }}" name="about_ar" id="about_ar">{{ old('about_ar') }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('terms_title_en') ? 'is-invalid' : '' }}" type="text" name="terms_title_en" id="terms_title_en" value="{{ old('terms_title_en', '') }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('terms_en') ? 'is-invalid' : '' }}" name="terms_en" id="terms_en">{{ old('terms_en') }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('terms_ar_title') ? 'is-invalid' : '' }}" type="text" name="terms_ar_title" id="terms_ar_title" value="{{ old('terms_ar_title', '') }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('terms_ar') ? 'is-invalid' : '' }}" name="terms_ar" id="terms_ar">{{ old('terms_ar') }}</textarea>
