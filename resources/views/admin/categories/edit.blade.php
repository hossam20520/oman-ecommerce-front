    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.categories.update", [$category->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('category') ? 'is-invalid' : '' }}" type="text" name="category" id="category" value="{{ old('category', $category->category) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('category_name_ar') ? 'is-invalid' : '' }}" type="text" name="category_name_ar" id="category_name_ar" value="{{ old('category_name_ar', $category->category_name_ar) }}" required>
