    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.orders.update", [$order->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('fname') ? 'is-invalid' : '' }}" type="text" name="fname" id="fname" value="{{ old('fname', $order->fname) }}" disabled>
                @if($errors->has('fname'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('lname') ? 'is-invalid' : '' }}" type="text" name="lname" id="lname" value="{{ old('lname', $order->lname) }}" disabled>
                @if($errors->has('lname'))
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('group') ? 'is-invalid' : '' }}" name="group" id="group" disabled>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('username') ? 'is-invalid' : '' }}" type="text" name="username" id="username" value="{{ old('username', $order->username) }}" disabled>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" type="email" name="email" id="email" value="{{ old('email', $order->email) }}" disabled>
                @if($errors->has('email'))
            ...
            <div class="form-group">
                ...
                <input disabled class="form-control {{ $errors->has('orderid') ? 'is-invalid' : '' }}" type="text" name="orderid" id="orderid" value="{{ old('orderid', $order->orderid) }}">
            ...
            <div class="form-group">
                ...
                <input disabled class="form-control {{ $errors->has('payment') ? 'is-invalid' : '' }}" type="text" name="payment" id="payment" value="{{ old('payment', $order->payment) }}">
            ...
            <div class="form-group">
                ...
                <input disabled class="form-control {{ $errors->has('street_1') ? 'is-invalid' : '' }}" type="text" name="street_1" id="street_1" value="{{ old('street_1', $order->street_1) }}">
            ...
            <div class="form-group">
                ...
                <input disabled class="form-control {{ $errors->has('city') ? 'is-invalid' : '' }}" type="text" name="city" id="city" value="{{ old('city', $order->city) }}">
                @if($errors->has('city'))
            ...
            <div class="form-group">
                ...
                <input disabled class="form-control {{ $errors->has('state') ? 'is-invalid' : '' }}" type="text" name="state" id="state" value="{{ old('state', $order->state) }}">
                @if($errors->has('state'))
            ...
            <div class="form-group">
                ...
                <input disabled class="form-control {{ $errors->has('country') ? 'is-invalid' : '' }}" type="text" name="country" id="country" value="{{ old('country', $order->country) }}">
            ...
            <div class="form-group">
                ...
                <input disabled class="form-control {{ $errors->has('zip') ? 'is-invalid' : '' }}" type="text" name="zip" id="zip" value="{{ old('zip', $order->zip) }}">
                @if($errors->has('zip'))
            ...
            <div class="form-group">
                ...
                <input disabled class="form-control {{ $errors->has('phone') ? 'is-invalid' : '' }}" type="text" name="phone" id="phone" value="{{ old('phone', $order->phone) }}">
                @if($errors->has('phone'))
            ...
            <div class="form-group">
                ...
                <input disabled class="form-control {{ $errors->has('total_cost') ? 'is-invalid' : '' }}" type="number" name="total_cost" id="total_cost" value="{{ old('total_cost', $order->total_cost) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input disabled class="form-control {{ $errors->has('date') ? 'is-invalid' : '' }}" type="text" name="date" id="date" value="{{ old('date', $order->date) }}" required>
                @if($errors->has('date'))
            ...
            <div class="form-group">
                ...
                <textarea disabled class="form-control {{ $errors->has('notes') ? 'is-invalid' : '' }}" name="notes" id="notes">{{ old('notes', $order->notes) }}</textarea>
                @if($errors->has('notes'))
