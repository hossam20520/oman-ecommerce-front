    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.inventories.update", [$inventory->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('inventory') ? 'is-invalid' : '' }}" type="number" name="inventory" id="inventory" value="{{ old('inventory', $inventory->inventory) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('brand') ? 'is-invalid' : '' }}" type="text" name="brand" id="brand" value="{{ old('brand', $inventory->brand) }}">
                @if($errors->has('brand'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('price_group_1') ? 'is-invalid' : '' }}" type="number" name="price_group_1" id="price_group_1" value="{{ old('price_group_1', $inventory->price_group_1) }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('price_group_2') ? 'is-invalid' : '' }}" type="number" name="price_group_2" id="price_group_2" value="{{ old('price_group_2', $inventory->price_group_2) }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('price_group_3') ? 'is-invalid' : '' }}" type="number" name="price_group_3" id="price_group_3" value="{{ old('price_group_3', $inventory->price_group_3) }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('price_group_4') ? 'is-invalid' : '' }}" type="number" name="price_group_4" id="price_group_4" value="{{ old('price_group_4', $inventory->price_group_4) }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('price_group_5') ? 'is-invalid' : '' }}" type="number" name="price_group_5" id="price_group_5" value="{{ old('price_group_5', $inventory->price_group_5) }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('price_group_6') ? 'is-invalid' : '' }}" type="number" name="price_group_6" id="price_group_6" value="{{ old('price_group_6', $inventory->price_group_6) }}" step="0.01" required>
