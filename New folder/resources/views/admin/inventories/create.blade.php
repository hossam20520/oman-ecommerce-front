...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.inventories.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label class="required" for="inventory">{{ trans('cruds.inventory.fields.inventory') }}</label>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('full_desc_ar') ? 'is-invalid' : '' }}" name="full_desc_ar" id="full_desc_ar" required>{{ old('full_desc_ar') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('short_desc') ? 'is-invalid' : '' }}" name="short_desc" id="short_desc">{{ old('short_desc') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('short_desc_ar') ? 'is-invalid' : '' }}" name="short_desc_ar" id="short_desc_ar" required>{{ old('short_desc_ar') }}</textarea>
            ...
            <div class="form-group">
                <label class="required" for="gallery">{{ trans('cruds.inventory.fields.gallery') }}</label>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('product_unit') ? 'is-invalid' : '' }}" name="product_unit" id="product_unit" required>
                    ...
                    @foreach(App\Models\Inventory::PRODUCT_UNIT_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('product_unit', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('box_quantity') ? 'is-invalid' : '' }}" type="number" name="box_quantity" id="box_quantity" value="{{ old('box_quantity', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('product_cost') ? 'is-invalid' : '' }}" type="number" name="product_cost" id="product_cost" value="{{ old('product_cost', '') }}" step="0.01">
            ...
            <div class="form-group">
                <label class="required" for="price_group_1">{{ trans('cruds.inventory.fields.price_group_1') }}</label>
                <input class="form-control {{ $errors->has('price_group_1') ? 'is-invalid' : '' }}" type="number" name="price_group_1" id="price_group_1" value="{{ old('price_group_1', '') }}" step="0.01" required>
            ...
            <div class="form-group">
                <label class="required" for="price_group_2">{{ trans('cruds.inventory.fields.price_group_2') }}</label>
                <input class="form-control {{ $errors->has('price_group_2') ? 'is-invalid' : '' }}" type="number" name="price_group_2" id="price_group_2" value="{{ old('price_group_2', '') }}" step="0.01" required>
            ...
            <div class="form-group">
                <label class="required" for="price_group_3">{{ trans('cruds.inventory.fields.price_group_3') }}</label>
                <input class="form-control {{ $errors->has('price_group_3') ? 'is-invalid' : '' }}" type="number" name="price_group_3" id="price_group_3" value="{{ old('price_group_3', '') }}" step="0.01" required>
            ...
            <div class="form-group">
                <label class="required" for="price_group_4">{{ trans('cruds.inventory.fields.price_group_4') }}</label>
                <input class="form-control {{ $errors->has('price_group_4') ? 'is-invalid' : '' }}" type="number" name="price_group_4" id="price_group_4" value="{{ old('price_group_4', '') }}" step="0.01" required>
            ...
            <div class="form-group">
                <label class="required" for="price_group_5">{{ trans('cruds.inventory.fields.price_group_5') }}</label>
                <input class="form-control {{ $errors->has('price_group_5') ? 'is-invalid' : '' }}" type="number" name="price_group_5" id="price_group_5" value="{{ old('price_group_5', '') }}" step="0.01" required>
            ...
            <div class="form-group">
                <label class="required" for="price_group_6">{{ trans('cruds.inventory.fields.price_group_6') }}</label>
                <input class="form-control {{ $errors->has('price_group_6') ? 'is-invalid' : '' }}" type="number" name="price_group_6" id="price_group_6" value="{{ old('price_group_6', '') }}" step="0.01" required>
            ...
            <div class="form-group">
                <label class="required">{{ trans('cruds.inventory.fields.product_unit_wholse') }}</label>
                <select class="form-control {{ $errors->has('product_unit_wholse') ? 'is-invalid' : '' }}" name="product_unit_wholse" id="product_unit_wholse" required>
                    ...
                    @foreach(App\Models\Inventory::PRODUCT_UNIT_WHOLSE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('product_unit_wholse', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('unit_qty') ? 'is-invalid' : '' }}" type="number" name="unit_qty" id="unit_qty" value="{{ old('unit_qty', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('items_per_unit') ? 'is-invalid' : '' }}" type="number" name="items_per_unit" id="items_per_unit" value="{{ old('items_per_unit', '') }}" step="1">
            ...
            <div class="form-group">
                <label class="required">{{ trans('cruds.inventory.fields.sale') }}</label>
                <select class="form-control {{ $errors->has('sale') ? 'is-invalid' : '' }}" name="sale" id="sale" required>
                    ...
                    @foreach(App\Models\Inventory::SALE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('sale', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
                @if($errors->has('sale'))
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('start_sale_date_time') ? 'is-invalid' : '' }}" type="text" name="start_sale_date_time" id="start_sale_date_time" value="{{ old('start_sale_date_time') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('end_sale_date_time') ? 'is-invalid' : '' }}" type="text" name="end_sale_date_time" id="end_sale_date_time" value="{{ old('end_sale_date_time') }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('howtouse') ? 'is-invalid' : '' }}" name="howtouse" id="howtouse">{{ old('howtouse') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('how_to_use_ar') ? 'is-invalid' : '' }}" name="how_to_use_ar" id="how_to_use_ar">{{ old('how_to_use_ar') }}</textarea>
